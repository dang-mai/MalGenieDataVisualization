$(function () {
        ...
        option = {
            ...
            series: [

                {
                    ...
                    data: [61, 135, 248, 426, 704, 1101, 1744, 2414, 3463, 3976, 4802, 6496, 8402],
                },
                // {
                //     name: '温度',
                //     type: 'bar',
    ...
    function ceshis1() {
        ...
        var color = ["#8d7fec", "#5085f2", "#e75fc3", "#f87be2", "#f2719a", "#fca4bb", "#f59a8f", "#fdb301", "#57e7ec", "#cf9ef1", "#e75fc3"]
        var xdata = ['backdoor', "botnet", "ddos", "keylogger", 'ransomware', 'rootkit', 'sniff', 'spam', 'spoof', 'spyware', 'trojan', 'worm', 'virus'];
    ...
    function ceshis2() {
        ...
        option = {
            ...
            "legend": {
                ...
                "padding": [70, 20],
                "itemGap": 5,
                "data": ["Windows", "Linux", "Mac", "Android", "Iphone", "Iot"]
            },
            "series": [{
                "type": "pie",
                "center": ["50%", "40%"],
